...
class _CommunityDetailsScreenState extends State<CommunityDetailsScreen>
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (_isAdmin) {
        _pendingRequests = await _communityService.getPendingJoinRequests(
          widget.community.id,
        );
      }
    } catch (e) {
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(
                        widget.community.isPrivate ? Icons.lock : Icons.public,
                        size: 18,
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 5),
                      Text(
                        '${widget.community.postCount} posts',
    ...
    showModalBottomSheet(
      ...
      builder: (context) => DraggableScrollableSheet(
        ...
        builder: (_, scrollController) =>
            CommunityMembersSheet(community: widget.community),
      ),
    );
  }
}
