...
class _CommunityDetailsScreenState extends State<CommunityDetailsScreen>
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (_isAdmin) {
        _pendingRequests =
            await _communityService.getPendingJoinRequests(widget.community.id);
      }
    } catch (e) {
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    Icon(widget.community.isPrivate ? Icons.lock : Icons.public,
                  ...
                  Row(children: [
                    ...
                    const SizedBox(width: 5),
                    Text('${widget.community.postCount} posts',
          ...
          children: [
            TabBar(
              ...
              tabs: [
                ...
                if (_isAdmin && widget.community.isPrivate)
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                          backgroundImage: thread.creator.avatarUrl != null
                              ? NetworkImage(thread.creator.avatarUrl!)
                              : null),
                      title: Text(thread.title,
                          style: const TextStyle(fontWeight: FontWeight.bold)),
                      subtitle: Text('${thread.messageCount} messages',
                          style: TextStyle(color: Colors.grey[600])),
                      ...
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => CommunityThreadScreen(
                              community: widget.community, thread: thread),
                        ),
                      ).then((_) => _loadData()),
                    ),
                  );
