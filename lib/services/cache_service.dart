...
class CacheService {
  ...
  Future<Map<String, dynamic>?> getCachedWeatherData() async {
    ...
    if (!prefs.containsKey(_weatherCacheKey) ||
        !prefs.containsKey(_weatherTimestampKey)) {
      return null;
    }
    ...
    if (cachedData != null) {
      ...
      if (decodedData.containsKey('forecast') &&
      ...
      if (decodedData.containsKey('hourlyForecast') &&
      ...
      if (decodedData.containsKey('farmingAdvice') &&
