  ...
  group('CustomButton', () {
    testWidgets('renders the provided text', (tester) async {
      await tester.pumpWidget(
        _wrap(CustomButton(text: 'Login', onPressed: () {})),
      );
    ...
    testWidgets('fires onPressed when tapped', (tester) async {
      var taps = 0;
      await tester.pumpWidget(
        _wrap(CustomButton(text: 'Tap me', onPressed: () => taps++)),
      );
      await tester.tap(find.byType(CustomButton));
      expect(taps, 1);
    });

    testWidgets('is disabled and swallows taps while loading', (tester) async {
      var taps = 0;
      await tester.pumpWidget(
        _wrap(
          CustomButton(
    ...
    testWidgets('is disabled when onPressed is null', (tester) async {
      await tester.pumpWidget(
        _wrap(const CustomButton(text: 'Disabled', onPressed: null)),
      );
    ...
    testWidgets('renders a leading icon when provided', (tester) async {
      await tester.pumpWidget(
        _wrap(
          CustomButton(text: 'Save', onPressed: () {}, leadingIcon: Icons.save),
        ),
      );
